...
abstract class FirebaseFunctionsService {
  ...
  /// during the call.
  Future<ResponseT> Function(RequestT req) createFunction<RequestT extends BaseModel, ResponseT extends BaseModel>(
    String path, {
    ...
    return ((RequestT req) async {
      try {
        ...
        final HttpsCallable callable = _functions.httpsCallable("$_prefix$path");
